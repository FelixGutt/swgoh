<><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><>
This document has swgod tips that have been used already
<><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><>
...
**You need to be level 65 to join.**
...
```fix
Tip of the Day - 2021-03-20
Galactic War, part 3
```
Galactic War (GW) is available once you turn level 40. It provides a large number of resources so it pays to focus on it. This Tip-of-the-Day has tips to help you win those harder battles.
...
One of the things GW is useful for is learning which characters work well against other characters. There is a lot of theory crafting in this and it can get a bit thick if you are also still trying to learn the game; however, this is a good time to start thinking about offensive strategies. For example consider if the problem you have is your opponents healing faster than you can hirt them consider bringing Dooku as a leader to inflict healing immunity. Need to slow down an opponent that is inflicting a lot of special debuffs on you right off the bat, consider bring Old Ben who has ability block... This is just a sampling, give them and others a try.
...
**GALACTIC WAR, PART 1**
* Take the time to do your galactic wars, these get you important rewards
...
**GALACTIC WAR, PART 2**
* Don't lose battles, retreat instead so you don't lose your squad, and worse, preload their turn meter
* Use the fact that your opponent does the same thing every time
* Try changing the order of your lineup
* Try sacrificing a weaker squad to get advantage by taking out one or more characters in the opposing squad
...
**GALACTIC WAR, ADDENDUM**
* When you get close to the end of any given battle, switch to just using basic attacks to finish it off. This way all your cooldowns have a chance to reset so you can use them right away in the next battle.
* If you get stuck and have already reset GW for the day, wait overnight and try again. You might gain a level or upgrade a character that will make the difference. If you haven't reset, give it your best effort then reset so you don't lose resources.


```fix
Tip of the Day - 2021-03-23
Communication and how it makes the guild work
```
Communication is important in any relationship and the TKA Boot Camp guild isn't any different. There are a couple of key points of communication that will make our guild the fabulous place we all want it to be.

**Messages from officers**
We try to keep "official" messages to a minimum; however, if we've tagged a message with `@TKA Boot Camp` please take time to read it to make sure it isn't relevant to you. When we start doing Territory Wars there will be communication in Discord about our plan and there will be directions in each territory during the war. Please read these and follow officer directions.

If we've reached out to you directly either in Discord or in game please respond. If we do not get a response we cannot resolve any issue we might be trying to understand and a likely result could be your account being removed from the guild.

**Player participation messages**
We have a channel #tka-boot-camp-absence for notifying the guild/officers if you have any reason to need to be away from the game. We appreciate your privacy. We don't need a reason for your absence, just a notification with an expected start and end date. If you don't feel comfortable sharing your absence on the guild absence channel, reach out to any guild officer directly. We will be happy to work with you for any extended absences (months).

**Provide Constructive Feedback**
We all have lives outside of SWGoH and are doing this on our own time because we love the game and sharing our love with others. If there is anything you'd like to see changed please just reach out either in one of our guild channels or if you are more comfortable, directly with any of the guild officers. Constructive, polite feedback will always be accepted in kind. We want this starter guild to be a fun place for everyone to come and relax and share their love of Star Wars and this game.

```fix
Tip of the Day - 2021-03-24
Resource Management - Maximizing Resources
```
As mentioned previously, SWGoH has a large component of resource management. One key to progressing in this game is to maximize your resources. Part of maximizing the effect of your resources is not using them on things not in your critical path but another large part is maximizing how many resources you get every day. Maximizing resources makes you stronger in Squad Arena and Fleet Arena which increases your rewards which makes you stronger yet.

**DAILY LOGIN REWARDS**
There are daily login rewards which vary from a few credits to zetas later in the month. The character shards given during a month are okay but are rarely going to be for a character on your path. Zetas are very limited in supply and you'll want to collect your daily rewards every day so you can get the late-month zeta rewards. The crystal rewards aren't bad either.
...
**In Summary**
* Log in every day
* Complete all your GW and Daily Challenges every day
* Collect all your free energy


```fix
Tip of the Day - 2021-03-25
...
**EARLY GAME**
I consider the early game to be levels 1-84. My focus during these levels is getting my next level, getting a solid foundation for my characters and teams, and preparing to be a resource to a bigger guild. I'm not super worried about building up a stockpile of any particular resource. In particular I tend to spend my daily crystals every day to run more missions. Missions get me gear for my characters, they get me experience to go up in levels faster, and they get me character shards. _All this gets me to mid-game faster._

_Goals:_ 
* Grow my levels as quickly as possible

**MID GAME**
Mid game can start before level 85 but this is when the whole game is opened up to you. My goals shift from growing my level to finishing my first non-Phoenix team. Phoenix are a great starter team but are abandoned by most people as soon as they have 7-star Thrawn. This next team is likely to be darkside to balance the Phoenix light side. I try to grow this second team to G13 and beyond.

I also start building a reserve of resources. I spend just enough Crystals per day to get my 600 raid tickets. I still remain focused on one team at a time. While growing my second team to G13 I am accumulating gear and other resources so the next team will grow faster.

_Goals:_
* Get 7-star Thrawn and abandon Phoenix
* Build second team to r5
* Start building resource reserves
...
* Activating and promoting characters/ships that you aren't going to use
...
Not at all, especially if you've spent real money on this game! All accounts have some amount of bloat. Most characters are useful eventually so you will be able to grow into them and they will change from bloat to useful characters. Because I wasn't given this tip early on, my main account has a fair amount of bloat. It is doing just fine.

**SUMMARY**
* You can minimize bloat but you cannot avoid it entirely
* Just because you _can_ upgrade something doesn't men you _should_
